...
def existePiso(pisoId: int):
    piso = db.session.query(Piso).filter_by(id=pisoId).first()
    return piso

def existePropietario(propietarioId: int=None, propietarioEmail: str=None):
